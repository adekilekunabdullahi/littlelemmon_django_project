This repository contains a web app built using django framework, It is a simple website called littlemon where user can order various kinds of food delicacies.
